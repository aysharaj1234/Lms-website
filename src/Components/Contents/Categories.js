...
<h4>Categories</h4>
<p>Create categories and add products for easy content discover</p>
<div className="d-flex flex-column flex-md-row align-items-md-center mt-3">
       ...
       Reorder
                ...
                <button className="btn btn-primary mt-3 mt-md-0 ms-md-3" type="submit"> <i class="fa-solid fa-gear"></i>  Settings
